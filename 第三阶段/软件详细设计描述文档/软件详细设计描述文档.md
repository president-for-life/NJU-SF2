...
<tr><td colspan="2"><center>需要的服务（需接口）</center></td></tr>

<tr><td>服务名</td><td>服务</td></tr>
<tr><td>ActivityMapper.selectActivitiesByMovie(int movieId)</td><td>选择优惠电影列表中含有某电影的优惠活动</td></tr>
<tr><td>ActivityMapper.selectActivitiesWithoutMovie()</td><td>选择条件为“观看任意电影”的优惠活动</td></tr>
<tr><td>CouponServiceForBl.issueCoupon(List<Integer> couponIdList, List<Integer> userIdList)</td><td>让多个观众每人都获得多个优惠劵</td></tr>
...
<tr><td>服务名</td><td>服务</td></tr>
<tr><td>CouponMapper.selectValidCoupons()</td><td>获得当前处于有效期的优惠劵</td></tr>
<tr><td>CouponMapper.insertCouponUser(couponId, userId)</td><td>让某观众获得某优惠劵</td></tr>
...
<tr><td>服务名</td><td>服务</td></tr>
<tr><td>VIPCardMapper.insertStrategy(VIPCardStrategy vipCardStrategy)</td><td>插入单一会员卡充值优惠策略</td></tr>
<tr><td>VIPCardMapper.updateStrategy(VIPCardStrategy vipCardStrategy)</td><td>更新单一会员卡充值优惠策略</td></tr>
<tr><td>VIPCardMapper.deleteStrategy(int id)</td><td>删除单一会员卡充值优惠策略</td></tr>
<tr><td>VIPCardMapper.selectStrategies()</td><td>查找所有会员卡充值优惠策略</td></tr>
<tr><td>VIPCardMapper.selectCardByUserId(int userId)</td><td>根据userId查找单一会员卡</td></tr>
<tr><td>VIPCardMapper.insertOneCard(VIPCard vipCard)</td><td>插入单一会员卡</td></tr>
<tr><td>VIPCardMapper.updateCardStrategy(int id, int strategyId)</td><td>更新单一会员卡充值优惠策略</td></tr>
<tr><td>VIPCardMapper.updateCardBalance(int id, double balance)</td><td>更新单一会员卡余额</td></tr>
<tr><td>VIPCardMapper.selectChargeRecordsByCard(int vipCardId)</td><td>根据vipCardId查找单一会员卡的多个充值记录</td></tr>
