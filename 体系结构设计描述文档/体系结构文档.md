...
<tr><td>语法</td><td>public vodi showMovieDetails(long movieID)</td></tr>
<tr><td>前置条件</td><td>无</td></tr>
...
<tr>
  <td>ScheduleDataService.delect(SchedulePO po)</td>
  <td>删除单一持久化对象</td>
</tr>
...
<tr>
  <td>语法</td>
  <td>public ResultMassage pay(String paymentType)</td>
</tr>
<tr>
  <td>前置条件</td>
  <td>已经确认订单</td>
...
<tr>
  <td>SalesDataService.find(int id)</td>
  <td>根据ID进行查找单一持久化对象</td>
</tr>

<tr>
  <td>SalesDataService.find(long movieDetailsID, Date time)</td>
  <td>根据电影和时间进行查找多个持久化对象</td>
</tr>
...
<tr> 
  <td>SalesDataService.delect(SalesPO po)</td>
  <td>删除单一持久化对象</td>
</tr>
...
<tr>
  <td>语法</td>
  <td>public ResultMassage checkBalance(long userID)</td>
</tr>
<tr>
  <td>前置条件</td>
  <td>无</td>
...
<tr>
  <td>语法</td>
  <td>public SalesPO find(long movieDetailsID, Date time) throws RemoteException;</td>
</tr>
<tr>
  <td>前置条件</td>
  <td>无</td>
...
<tr>
  <td>后置条件</td>
  <td>按电影IDmovieDetailsID和时间time进行查找返回相应的PO结果</td>
</tr>
