...
| CouponServiceImpl.getCoupons | 语法 | public Response getCoupons() |
| ---------------------------- | ---- | ---------------------------- |
|                              |      |                              |

需要的接口

| couponMapper.getAllCoupons() | 获得多个持久化对象 |
| ---------------------------- | ------------------ |
|                              |                    |
...
| 服务名                                          | 服务                             |
| ----------------------------------------------- | -------------------------------- |
| statisticsMapper.selectChrage(int userId)       | 根据userId查找多个持久化对象     |
| statisticsMapper.selectTicket(int userId)       | 根据userId查找多个持久化对象     |
| statisticsMapper.selectSchedule(int scheduleId) | 根据scheduleId查找多个持久化对象 |
| statisticsMapper.selectUsers()                   | 获取多个持久化对象               |
