...
| 开发（物理）包          | 依赖的其他开发包                                                           |
| :---------------------: | -------------------------------------------------------------------------- |
| mainui                  | userui, moviedetailsui, likeui, scheduleui, promotionui, salesui, memberui |
| userui                  |  |
| userblservice           |  |
| userbl                  |  |
| userdataservice         |  |
...
- 描述数据持久化对象(PO)
  ...
  -LikePO类包含一个由电影详情编号MoviedetailsID和用户编号UserID组成的Map
  -SchedelePO类包含放映时间、放映影厅、电影详情编号MoviedetailsID、票价、是否可见
  -PromotionPO类包含优惠时间段、优惠金额、优惠条件
  -HaspromotionPO类包含一个由用户编号UserID和促销编号PromotionID组成的Map
